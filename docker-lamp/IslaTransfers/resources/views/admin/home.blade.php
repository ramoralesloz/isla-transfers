...
@section('content')
    <header class="admin-header">
        ...
        <nav>
            <ul>
                ...
                <li><a href="{{ route('hotel.comisiones') }}"><i class="fas fa-coins"></i> Ver Comisiones de Hoteles</a></li>
                </ul>
        </nav>
    </header>
    ...
    <main>
        ...
        <section id="listar-reservas" class="admin-section">
            ...
            <p>Consulta una vista por semana, por día y por mes de los trayectos que han de realizar. Los trayectos se deben mostrar en formato calendario y se puede acceder a información detallada de cada trayecto.</p>
        ...
        <section id="ver-vehiculos" class="admin-section">
            ...
            <a href="{{ route('vehiculo.listar') }}" class="button"><i class="fas fa-car"></i> Ver Vehículos</a>
        </section>
        ...
        <section id="ver-comisiones" class="admin-section">
            <h2>Ver Comisiones de Hoteles</h2>
            <p>Consulta las comisiones generadas por cada hotel en el sistema, tanto de forma mensual como acumulada.</p>
            <a href="{{ route('hotel.comisiones') }}" class="button"><i class="fas fa-coins"></i> Ver Comisiones</a>
        </section>
    </main>
@endsection
